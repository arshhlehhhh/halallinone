    ...
    <b-col>
      ...
      <div class="region-jumbotron">
        <b-jumbotron class="justify-content-center text-center text-black vertical-center" style="opacity: 0.7; height: 380px; ">
            <div class="container">
              <h1 style="font-size: 55px;">NORTH</h1>
              <p style="font-size: 18px;">The North Region of Singapore is one of the five regions in the city-state. The
              region is the second largest region in terms of land area, and has a population of 531,860.</p>
      ...
      <div style="margin-top: 20px;">
        ...
        <div class="content">
          ...
          <div v-if="restaurants.Restaurant != undefined" :key="1">
                  ...
                  <b-carousel-slide v-for="(stores, index) in filterRestaurant(location.name)" :key="index">
                    ...
                    <template v-slot:img>
                      <b-card-group deck class="justify-content-center">
                        <span v-show="stores.length < 1"><b-icon icon="arrow-clockwise" animation="spin" font-scale="4" variant="success"></b-icon></span>
            ...
            <!-- Filtered view -->
            <div id="cardGroup">
              <b-card-group deck id="cards" class="justify-content-center">
                <span v-for="store in cards(selectedLocation)" :key="store.id">
                  <span v-if="store.location === selectedLocation">
                    <RestaurantCard :id="store.rid" :stall="store" :key="componentKey"/>
                  </span>
                </span>
              </b-card-group>
            </div>
          ...
          <div v-else style="text-align: center; color: white;" :key="2">
...
export default {
  ...
  data () {
    return {
      locations: [
        { name: 'Admiralty', value: 'Admiralty' },
        { name: 'Ang Mo Kio', value: 'Ang Mo Kio' },
        { name: 'Bishan', value: 'Bishan' },
        { name: 'Khatib', value: 'Khatib' },
        { name: 'Sembawang', value: 'Sembawang' },
        { name: 'Toa Payoh', value: 'Toa Payoh' },
        { name: 'Woodlands', value: 'Woodlands' },
        { name: 'Yishun', value: 'Yishun' }
      ],
      cuisines: [
