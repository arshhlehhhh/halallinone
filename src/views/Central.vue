    ...
    <b-col>
      ...
      <div class="region-jumbotron">
        <b-jumbotron class="justify-content-center text-center text-black vertical-center" style="opacity: 0.7; height: 380px; ">
            <div class="container">
              <h1 style="font-size: 55px;">CENTRAL</h1>
              <p style="font-size: 18px;">The Central Region is one of the five regions in the city-state of Singapore and
              the main metropolitan region surrounding the Central Area.</p>
...
export default {
  ...
  data () {
    return {
      locations: [
        ...
        { name: 'City Hall', value: 'City Hall' },
        { name: 'Dhoby Ghaut', value: 'Dhoby Ghaut' },
  ...
  created () {
    this.$store.dispatch('loadCentral')
  },
  methods: {
    onSlideStart (slide) {
      this.sliding = true
