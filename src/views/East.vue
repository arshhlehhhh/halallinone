    ...
    <b-col>
      ...
      <div class="region-jumbotron">
        <b-jumbotron class="justify-content-center text-center text-black vertical-center" style="opacity: 0.7; height: 380px; ">
            <div class="container">
              <h1 style="font-size: 55px;">EAST</h1>
              <p style="font-size: 18px;">The East Region of Singapore is one of the five regions in the city-state. The region is the 2nd most densely populated among the five, and has the smallest land area.</p>
                      ...
                      <b-card-group deck class="justify-content-center">
                        <span v-for="(store, index) in stores" :key="index">
                          ...
                          <span v-if="stores !== 'empty'">
                            <RestaurantCard :id="store.rid" :stall="store" v-b-tooltip.hover title="Click to view restaurant info."/>
                          </span>
...
export default {
  ...
  data () {
    return {
      locations: [
        { name: 'Bedok', value: 'Bedok' },
        { name: 'Changi Airport', value: 'Changi Airport' },
        { name: 'Pasir Ris', value: 'Pasir Ris' },
        { name: 'Paya Lebar', value: 'Paya Lebar' },
        { name: 'Simei', value: 'Simei' },
        { name: 'Tampines', value: 'Tampines' }
      ],
      cuisines: [
