    ...
    <b-col>
      ...
      <div class="region-jumbotron">
        <b-jumbotron class="justify-content-center text-center text-black vertical-center" style="opacity: 0.7; height: 380px; ">
            <div class="container">
              <h1 style="font-size: 55px;">WEST</h1>
              <p style="font-size: 18px;">The West Region of Singapore is one of the five regions in the city-state. The
              region is the largest in terms of land area and is the second most populous region after the Central
              Region</p>
...
export default {
  ...
  data () {
    return {
      locations: [
        { name: 'Boon Lay', value: 'Boon Lay' },
        { name: 'Clementi', value: 'Clementi' },
        { name: 'Jurong East', value: 'Jurong East' },
        { name: 'Lakeside', value: 'Lakeside' },
