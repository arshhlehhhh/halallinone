  ...
  <b-row class="settings">
    ...
    <b-col>
      ...
      <div class="password-content">
        ...
        <b-button v-on:submit="emailreset()" style="background-color: #155C2D ; width:100%;"><router-link to="/forgetpassword" style="text-decoration:none; color:white">Reset through email!</router-link></b-button>
        <br>
        <br>
      </div>
      </div>
