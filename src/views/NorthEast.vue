  ...
  <b-row class="region">
    ...
    <b-col>
      ...
      <b-overlay show opacity="0.75" variant="light">
        <img src="../assets/SG-regions.png" height="380px" width="100%">
        <template v-slot:overlay>
          <div class="w-100 text-center">
            <h1 style="font-size: 60px; margin-bottom: 20px;">NORTH-EAST</h1>
            <p style="font-size: 18px;">The North-East Region of Singapore is one of the five regions in the city-state.
              The region is the most densely populated and has the third highest population among the five.</p>
...
export default {
  ...
  data () {
    return {
      locations: [
        { name: 'Hougang', value: 'Hougang' },
        { name: 'Punggol', value: 'Punggol' },
        { name: 'Sengkang', value: 'Sengkang' },
        { name: 'Serangoon', value: 'Serangoon' }
      ],
      cuisines: [
      ...
      selectedLocation: 'The North-East',
      componentKey: 0,
  ...
  created () {
    this.$store.dispatch('loadNorthEast')
  },
  methods: {
    onSlideStart (slide) {
      this.sliding = true
